...
const Guarded = ({ permissions, moduleLabel, children }) => (
  <PermissionGuard permissions={permissions} moduleLabel={moduleLabel}>
    {children}
  </PermissionGuard>
);
    ...
    <>
      ...
      <Suspense fallback={<GlobalSpinner />}>
        <Routes>
          ...
          <Route path="clients" element={<Guarded permissions={permissionMap.clients.list} moduleLabel="Clients"><ClientsAndUnClients /></Guarded>} />
          <Route path="legcase-services" element={<Guarded permissions={permissionMap.services.list} moduleLabel="Services"><LegalServiceList /></Guarded>} />
          <Route path="court-search" element={<Guarded permissions={permissionMap.reports.view} moduleLabel="Court Search"><CourtSearch /></Guarded>} />
          <Route path="cases_setting" element={<Guarded permissions={permissionMap.courts.list} moduleLabel="Court Settings"><CaseTypeSet /></Guarded>} />
          <Route path="lawyers" element={<Guarded permissions={permissionMap.lawyers.list} moduleLabel="Lawyers"><LawyerList /></Guarded>} />
          <Route path="legcases/show/:id" element={<Guarded permissions={permissionMap.legalCases.view} moduleLabel="Case Details"><LegCaseDetails /></Guarded>} />
          <Route path="profile/:userId" element={<ProfileUser />} />
          <Route path="legcases" element={<Guarded permissions={permissionMap.legalCases.list} moduleLabel="Legal Cases"><LegalCasesIndex /></Guarded>} />
          <Route path="search-courts-api" element={<Guarded permissions={permissionMap.courts.search} moduleLabel="Courts"><SearchCourtsApi /></Guarded>} />
          <Route path="reports" element={<Guarded permissions={permissionMap.reports.view} moduleLabel="Reports"><ReportsIndex /></Guarded>}>
          ...
          <Route path="admin/users" element={<Guarded permissions={permissionMap.adminUsers.list} moduleLabel="Admin Users"><AdminUsersPage /></Guarded>} />
          <Route path="admin/roles" element={<Guarded permissions={permissionMap.adminRoles.list} moduleLabel="Admin Roles"><AdminRolesPage /></Guarded>} />
          <Route path="admin/permissions" element={<Guarded permissions={permissionMap.adminPermissions.list} moduleLabel="Admin Permissions"><AdminPermissionsPage /></Guarded>} />
