    ...
    items: [
      {
        ...
        children: [
          ...
          { key: "admin_access", labelKey: "navigation.usersPermissions", icon: ShieldCheck, path: "/dashboard/admin/access", requiredPermission: [permissionMap.adminUsers.list, permissionMap.adminRoles.list, permissionMap.adminPermissions.list] },
        ],
      },
    ],
  },
