 ...
 <div
  ...
  >
    ...
    <div
      className={[
        "mt-3 w-full flex flex-wrap gap-2 text-sm",
    ...
    {/* ✅ Actions block (RTL => left) */}
    <div
  className={[
    "w-full lg:w-auto flex shrink-0 flex-wrap items-center gap-2",
    isRTL ? "lg:order-1 justify-start" : "lg:order-2 justify-end",
  ].join(" ")}
>
              <button
