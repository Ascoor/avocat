...
const ReportTabPage = ({ tabKey }) => {
  const { tabSchema, filters, options, rows, meta, loading, error, hasSearched, submitFilters, resetFilters, changePage, retry } = useReportsQuery(tabKey);

  return (
    <div className="space-y-4">
      <ReportFilters schema={tabSchema} values={filters} options={options} onSubmit={submitFilters} onReset={resetFilters} />
