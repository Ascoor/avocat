...
import { ArrowLeft, ArrowRight, Shield, Scale, Users, FileText, Briefcase, ChevronLeft, ChevronRight, Zap, Eye, Clock, CheckCircle2, RefreshCw, Target } from "lucide-react";
...
import { services, industries, teamMembers, articles } from "@/data/siteData";
...
const HomePage = () => {
  ...
  const trustItems = [
    { icon: Scale, key: "trust.consultation" },
    { icon: FileText, key: "trust.contracts" },
    { icon: Shield, key: "trust.litigation" },
    { icon: Briefcase, key: "trust.management" },
    { icon: Eye, key: "trust.followup" },
  ];

  const whyCards = [
    { icon: Shield, titleKey: "why.1.title", descKey: "why.1.desc" },
    { icon: Zap, titleKey: "why.2.title", descKey: "why.2.desc" },
    { icon: Clock, titleKey: "why.3.title", descKey: "why.3.desc" },
    { icon: Eye, titleKey: "why.4.title", descKey: "why.4.desc" },
  ];
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6">
                {t(`hero.${currentSlide + 1}.title`)}
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 leading-relaxed">
                {t(`hero.${currentSlide + 1}.desc`)}
              </p>
