...
use App\Http\Controllers\Api\OfficePreferenceController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('legcases', [LegCaseController::class, 'index'])->middleware('permission.guard:cases.view,cases.list');
        ...
        Route::get('offices/{officeId}/preferences', [OfficePreferenceController::class, 'show'])->middleware('permission.guard:settings.manage,officeSettings.manage');
        Route::put('offices/{officeId}/preferences', [OfficePreferenceController::class, 'update'])->middleware('permission.guard:officeSettings.manage');
